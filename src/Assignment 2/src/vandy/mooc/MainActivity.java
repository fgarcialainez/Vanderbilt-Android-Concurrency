...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // with the user.
        mPingPongTextViewLog = (TextView) findViewById(R.id.pingpong_text_output);
        mPingPongScrollView = (ScrollView) findViewById(R.id.scrollview_text_output);
        mPingPongColorOutput = (TextView) findViewById(R.id.pingpong_color_output);
    ...
    public void playButtonClicked(View view) {
        if (mProgramState == null) {
            ...
            // reset.
            mOutputStrategy.errorLog("MainActivity", "encountered a null state, which was then set to RESET");
        ...
        case RUN:
            ...
            mPlayPingPong = new PlayPingPong(mMaxIterations, mOutputStrategy);
            ...
            mDelayedOutputThread = new DelayedOutputThread(mPlayPingPong);
