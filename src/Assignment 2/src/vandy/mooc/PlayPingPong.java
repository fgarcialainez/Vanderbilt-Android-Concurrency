...
public class PlayPingPong implements Runnable {
     ...
     */
    // @@ TODO - you fill in here.
    private final CyclicBarrier mCyclicBarrier = new CyclicBarrier(2);
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            if (mIterationsCompleted <= (mMaxIterations / 2)) {           	
            	String outputString = "";
     ...
     */
    public PlayPingPong(int maxIterations, OutputStrategy outputStrategy) {
    ...
    public void run() {
        ...
        // @@ TODO - you fill in here.
        final PingPongThread pingHandlerThread = new PingPongThread(PingPong.PING);
        final PingPongThread pongHandlerThread = new PingPongThread(PingPong.PONG);

        // Start ping and pong threads, which cause their Looper to loop.
        // @@ TODO - you fill in here.
        pingHandlerThread.start();
        pongHandlerThread.start();

        // Barrier synchronization to wait for all work to be done
        // before exiting play().
        // @@ TODO - you fill in here.
        try {
        	pingHandlerThread.join();
        	pongHandlerThread.join();
