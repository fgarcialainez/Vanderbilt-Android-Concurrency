...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    public void downloadImage(View view) {
    	Log.d(TAG, "downloadImage(): download image button tapped");
    	...
    	try {
            ...
            if(imageUrl != null) {
                ...
                // @@ TODO - you fill in here.
            	Intent downloadIntent = makeDownloadImageIntent(imageUrl);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // @@ TODO -- you fill in here, replacing true with the right code.
    	if (resultCode == Activity.RESULT_OK) {
    		...
    		if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
                ...
                // by passing in the path to the downloaded image file.
                // @@ TODO -- you fill in here.
            	Parcelable imageUrl = data.getParcelableExtra(DownloadImageActivity.DOWNLOADED_IMAGE_URL_INTENT_PARAM);
            	
            	// Sanity check
            	if(imageUrl != null) {
            		Intent galleryIntent = makeGalleryIntent(imageUrl.toString());
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        // the image.
    	// TODO -- you fill in here, replacing "null" with the propercode.
    ...
    protected Uri getUrl() {
        ...
        // @@ TODO -- you fill in here, replacing "true" with the proper code.
        uri = url.toString();
        if (uri != null && uri.length() > 0 && Patterns.WEB_URL.matcher(uri).matches())
            return url;
        else {
